...
void egc_init_plug (void)
{
	...
	egc_system_name = "management";
	egc_system_location = "C:\\Users\\Alyona\\Documents\\Eiffel User Files\\15.08\\projects\\MANAGEMENT\\EIFGENs\\management\\W_code";
	egc_compiler_tag = 38;
