...
extern EIF_TYPED_VALUE F973_7252(EIF_REFERENCE);
extern EIF_TYPED_VALUE F973_7253(EIF_REFERENCE);
extern EIF_TYPED_VALUE F973_7254(EIF_REFERENCE);
...
EIF_TYPED_VALUE F973_7252 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F973_7253 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F973_7254 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 972, Current, 0, 0, 13524);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(972, Current, 13524);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5036, "fractional_second", tr1));
