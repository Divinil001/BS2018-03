...
extern EIF_TYPED_VALUE F964_7159(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F964_7152,13439,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {277,231,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13440);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13441);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13442);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
{
	GTCX
	RTOTC (F964_7157,13444,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F964_7158,13445,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F964_7159 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F964_7159,13446,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit964 (void)
{
	GTCX
	RTOTS (7152,F964_7152)
