...
extern EIF_TYPED_VALUE F968_7195(EIF_REFERENCE);
extern EIF_TYPED_VALUE F968_7196(EIF_REFERENCE);
extern EIF_TYPED_VALUE F968_7197(EIF_REFERENCE);
extern EIF_TYPED_VALUE F968_7198(EIF_REFERENCE);
extern EIF_TYPED_VALUE F968_7199(EIF_REFERENCE);
extern EIF_TYPED_VALUE F968_7200(EIF_REFERENCE);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 967, Current, 0, 0, 13482);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTNHOOK(1,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4985, "time_default_format_string", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
