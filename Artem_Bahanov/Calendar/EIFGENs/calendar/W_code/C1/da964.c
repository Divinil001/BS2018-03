...
extern EIF_TYPED_VALUE F964_7130(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F964_7123,13313,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13313);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13313);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13314);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13314);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13315);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13315);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13316);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13316);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F964_7128,13318,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F964_7129,13319,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F964_7130 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F964_7130,13312,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit964 (void)
{
	GTCX
	RTOTS (7123,F964_7123)
	RTOTS (7124,F964_7124)
	RTOTS (7125,F964_7125)
	RTOTS (7126,F964_7126)
	RTOTS (7127,F964_7127)
	RTOTS (7128,F964_7128)
	RTOTS (7129,F964_7129)
	RTOTS (7130,F964_7130)
}
