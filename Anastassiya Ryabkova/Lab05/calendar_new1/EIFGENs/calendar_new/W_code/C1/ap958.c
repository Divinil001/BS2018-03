...
#define ui4_1 ui4_1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4937, 0xF80003BE, 0); /* person */
	tr1 = RTLNSMART(RTWCT(4937, dtype, Dftype(Current)).id);
	tr2 = RTMS_EX_H("Anastassiya",11,1080284001);
	ur1 = tr2;
	...
	*(EIF_REFERENCE *)(Current + RTWA(4937, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	RTNHOOK(2,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4927, "name", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur1 = RTCCL(tr2);
