...
extern EIF_TYPED_VALUE F972_7211(EIF_REFERENCE);
...
EIF_TYPED_VALUE F972_7211 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 971, Current, 0, 0, 13386);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(971, Current, 13386);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5031, "fractional_second", tr1));
