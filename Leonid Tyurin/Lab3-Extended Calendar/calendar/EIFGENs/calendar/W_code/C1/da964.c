...
extern EIF_TYPED_VALUE F964_7144(EIF_REFERENCE);
extern EIF_TYPED_VALUE F964_7145(EIF_REFERENCE);
...
EIF_TYPED_VALUE F964_7144 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F964_7144,13410,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F964_7145)
EIF_TYPED_VALUE F964_7145 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13410);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13410);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13411);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13411);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13412);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13412);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F964_7149,13415,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F964_7150,13416,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F964_7151,13417,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit964 (void)
{
	GTCX
	RTOTS (7144,F964_7144)
	RTOTS (7145,F964_7145)
	RTOTS (7146,F964_7146)
	RTOTS (7147,F964_7147)
	RTOTS (7148,F964_7148)
	RTOTS (7149,F964_7149)
	RTOTS (7150,F964_7150)
	RTOTS (7151,F964_7151)
}
