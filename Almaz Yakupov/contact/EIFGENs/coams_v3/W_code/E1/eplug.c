...
void egc_init_plug (void)
{
	...
	egc_system_name = "coams_v3";
	egc_system_location = "C:\\Users\\Almaz\\Desktop\\UI\\Introduction to Programming\\Eiffel Lessons\\Homework_2\\coams_v3\\EIFGENs\\coams_v3\\W_code";
	egc_compiler_tag = 38;
